...
class UpdateCheckerTest {
    ...
    fun testIsVersionNewer() {
        ...
        assertTrue(UpdateChecker.isVersionNewer("1.2.0", "1.1.6.1"))
        assertTrue(UpdateChecker.isVersionNewer("2.0.0", "1.1.6.1"))
        ...
        assertFalse(UpdateChecker.isVersionNewer("1.1.6.1", ""))
    }
}
