...
В этой директории собраны вспомогательные утилиты для разработки, сборки и деплоя компонентов Mirrly TG Proxy.
...
* **`clean_all.ps1`** — Очистка кэшей Gradle, Cargo, CXX и временных артефактов.
