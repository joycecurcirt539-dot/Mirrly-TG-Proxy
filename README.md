...
3. [Архитектура надежности и особенности Mirrly TG Proxy](#3-архитектура-надежности-и-особенности-mirrly-tg-proxy)
...
## 3. Архитектура надежности и особенности Mirrly TG Proxy

### Ключевые достоинства проекта:
- Нативное ядро C/Rust с прямым вызовом JNA: Исключает оверхед виртуальной машины Java, обеспечивая высокую скорость работы и экономию заряда аккумулятора.
- Технология прогретых сокетов WsPool: Постоянный активный пул сокетов к дата-центрам Telegram (DC1-DC5) минимизирует задержку первичного рукопожатия при отправке сообщений.
...
2. При поступлении запроса от клиента Telegram сокет выбирается из готового пула мгновенно (без задержки на повторный Handshake).
...
**Проект находится в стабильной версии v1.0.3.**
