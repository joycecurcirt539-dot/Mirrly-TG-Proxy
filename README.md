...
<br/>
[![Version](https://img.shields.io/badge/Релиз-v1.1.6.1-1E293B?logo=github&logoColor=00E676)](https://github.com/joycecurcirt539-dot/Mirrly-TG-Proxy/releases)
...
| Критерий / Технология | Обычный системный VPN | TG WS Proxy *(Flowseal)* | tg-ws-proxy-android *(amurcanov)* | Устаревшие консольные порты *(MTG / Tele-Proxy / Termux)* | Mirrly TG Proxy *(Rust Core v1.1.6.1 by R1Xern)* |
| :--- | :--- | :--- | :--- | :--- | :--- |
